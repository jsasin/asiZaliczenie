...
class WeaponsControllerTest < ActionController::TestCase
  ...
  test "should create weapon" do
    assert_difference('Weapon.count') do
      post :create, weapon: { caliber: @weapon.caliber, description: @weapon.description, name: @weapon.name }
    end
  ...
  test "should update weapon" do
    patch :update, id: @weapon, weapon: { caliber: @weapon.caliber, description: @weapon.description, name: @weapon.name }
    assert_redirected_to weapon_path(assigns(:weapon))
  end
